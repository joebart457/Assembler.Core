...
public class ExportsSection : Section
{
    public override byte[] Name => ".edata".GetBytes(8);
    ...
    public override UInt32 Characteristics => SectionCharacteristics.ContainsInitializedData | SectionCharacteristics.MemRead;
